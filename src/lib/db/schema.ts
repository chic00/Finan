...
export const bankAccounts = pgTable('bank_accounts', {
  ...
  type: varchar('type', { length: 50 }).notNull(), // checking, savings, wallet, investment
...
export const transactions = pgTable('transactions', {
  ...
  toAccountId: uuid('to_account_id').references(() => bankAccounts.id, { onDelete: 'set null' }), // for transfers
