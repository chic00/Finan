...
ALTER TABLE "recurring_transactions" ADD CONSTRAINT "recurring_transactions_account_id_bank_accounts_id_fk" FOREIGN KEY ("account_id") REFERENCES "public"."bank_accounts"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "recurring_transactions" ADD CONSTRAINT "recurring_transactions_to_account_id_bank_accounts_id_fk" FOREIGN KEY ("to_account_id") REFERENCES "public"."bank_accounts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "budgets_user_month_idx" ON "budgets" USING btree ("user_id","month","year");--> statement-breakpoint
CREATE INDEX "categories_user_id_idx" ON "categories" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "transaction_tags_pk" ON "transaction_tags" USING btree ("transaction_id","tag_id");--> statement-breakpoint
...
CREATE INDEX "verification_token_key" ON "verification_tokens" USING btree ("identifier","token");